...
func (s *searchService) Search(ctx context.Context, req *SearchRequest) (*SearchResponse, error) {
	...
	userCfg, providerCfg, quota, err := s.resolveProviderConfig(resolved.UserID, resolved.SkipUserConfig)
	if err != nil {
		return nil, err
	}
...
func (s *searchService) resolveProviderConfig(userID uint, skipUserConfig bool) (*entity.UserConfig, external.SearchProviderConfig, *SearchQuota, error) {
